...
box1.style.backgroundColor = `rgb(${red1} ,${green1} ,${blue1})`;
...
box2.style.backgroundColor = `rgb(${red2} ,${green2} ,${blue2})`;
...
box3.style.backgroundColor = `rgb(${red3} ,${green3} ,${blue3})`;
...
box4.style.backgroundColor = `rgb(${red4} ,${green4} ,${blue4})`;